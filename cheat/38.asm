section .data
    ...
    delete_prompt_msg db "Enter value to delete: "
    len_delete_prompt equ $ - delete_prompt_msg
    list_msg db "Original list: "
    len_list_msg equ $ - list_msg
    modified_list_msg db "Modified list: "
    len_modified_list_msg equ $ - modified_list_msg
    space db " "
    newline db 10
...
.create_loop:
    ...
    ; Print original linked list message
    mov eax, 4
    mov ebx, 1
    mov ecx, list_msg
    ...
    ; Prompt for value to delete
    mov eax, 4
    mov ebx, 1
    mov ecx, delete_prompt_msg
    mov edx, len_delete_prompt
    int 0x80
    ...
    ; Print modified linked list message
    mov eax, 4
    mov ebx, 1
    mov ecx, modified_list_msg
    mov edx, len_modified_list_msg
    int 0x80
