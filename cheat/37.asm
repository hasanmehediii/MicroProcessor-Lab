section .data
    ...
    reversed_list_msg db "Reversed list: "
    len_reversed_list_msg equ $ - reversed_list_msg
    space db " "
    newline db 10
...
.create_loop:
    ...
    ; Print reversed linked list message
    mov eax, 4
    mov ebx, 1
    mov ecx, reversed_list_msg
    mov edx, len_reversed_list_msg
    int 0x80
